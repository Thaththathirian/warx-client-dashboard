...
import { Search, Bell, HelpCircle, Settings, Menu, Moon, Sun } from "lucide-react";
      ...
      <div className="flex h-16 items-center px-4 md:px-6">
        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="flex items-center gap-1.5">
            <span className="text-xl font-medium bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
              Anti-Piracy
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="relative h-9 w-9 rounded-full border-2 border-transparent hover:border-primary/20"
              >
                <Avatar>
            ...
            <DropdownMenuContent
              align="end"
              className="w-56 mt-1 rounded-xl shadow-medium"
            >
              <DropdownMenuLabel>
